...
export default {
  ...
  data() {
    return {
      ...
      lead: '<p>大学で研究される学問領域は細分化が進み、いまや学会の数はなんと2,022もあるのだとか。このなかから、本当に「自分らしい学問」を選ぶのは至難のわざかもしれません。</p><p>京都大学 学際融合教育研究推進センターは1,757人の研究者からのデータを元に、12の領域の中からあなたにふさわしい学問領域を教えてくれる診断ツール「Your Schola」と、膨大な学問分野の関係性を解き明かす分野相関図「Schola Scope」を開発しました。</p><p>いま研究者の方も、これから研究者を目指す方も、まずは一度、自分とその学問との「相関」を見てみよう！</p>',
